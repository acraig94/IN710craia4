...
namespace DogSelector
{
    ...
    {
        private const int NOPREFERENCE = 3;

        private List<Dog> db { get; set; }
        ...
        public int IsAMatch(int a, int b)
        {
            if (a == b || b == NOPREFERENCE)
            {
                return 1;
            }
            else return 0;
        ...
        public int IsAMatch(bool a, bool b)
        {
            if (a == b)
            {
                return 1;
        ...
        public void PrintInfo(List<Dog> d)
        {
            foreach (Dog i in d)
                Console.WriteLine(i.BreedName + " = " + i.Points);
        }
